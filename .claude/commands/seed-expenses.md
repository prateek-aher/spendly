...
- user_id - integer
- count - integer, no. of expenses to create
...
6. Inserts all expenses in a single transaction - roll back everything if any insertion fails.

## Step 4 - Confirm

Print:
- How many expenses were inserted
- The date range they span across
